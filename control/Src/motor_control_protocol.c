...
#include "system_acknowledgement_message.h"
...
__weak void MCP_ReceivedFrame(MCP_Handle_t *pHandle, uint8_t Code, uint8_t *buffer, uint8_t Size)
{
  ...
  case MC_PROTOCOL_CODE_GET_MP_INFO:
    ...
    case MC_PROTOCOL_CODE_SET_SYSTEM_CONF:  /* Set system control configuration */
    {
    		...
    		switch(bSysID)
    		{
    			...
    			case MC_PROTOCOL_SYS_LIGHT_OFF:
    			{
    				/*Send 8 bit variables*/
    			...
    			case MC_PROTOCOL_SYS_LIGHT_TOGGLE:
    			{
    				/*Send 8 bit variables*/
